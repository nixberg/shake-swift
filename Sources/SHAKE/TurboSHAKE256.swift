public struct TurboSHAKE256: ~Copyable {
    private var shake: SHAKE<Capacity256, KeccakP12>
...
extension TurboSHAKE256 {
    public struct Output: IteratorProtocol, Sequence {
        fileprivate var output: SHAKE<Capacity256, KeccakP12>.Output.Iterator
